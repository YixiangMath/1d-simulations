...
saveas(h, '/Users/ywu/Library/Mobile Documents/com~apple~CloudDocs/My Papers/2023-3-degenerate SIS/1d simulations/stDS00T100', 'epsc');
...
c = [1; 1];                                  
f = [0; 1] .* DuDx;                   
F=(2.5+sin(pi*x)).*u(1).*u(2)./(u(1)+u(2))-(1.5+sin(pi*x))*u(2);
%y = u(1) - u(2);
